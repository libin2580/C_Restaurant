...
public class WaiterMenuAdapter extends RecyclerView.Adapter<WaiterMenuAdapter.ViewHolder> {
    ...
    public WaiterMenuAdapter(Context context, ArrayList<MenuModel> values) {
